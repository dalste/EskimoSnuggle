...
-- $TexturePacker:SmartUpdate:8c30be9f7e7b499a930d8a30f3ce1afb$
-- 
-- Usage example:
	...
	return {
		frames = {
			...
			},
			{
				...
				textureRect = { x = 87, y = 197, width = 83, height = 75 },
			...
			},
			{
				name = "player02.png",
				spriteColorRect = { x = 0, y = 0, width = 83, height = 75 },
				textureRect = { x = 2, y = 428, width = 83, height = 75 },
				spriteSourceSize = { width = 83, height = 75 },
				spriteTrimmed = false,
				textureRotated = false
			},
			{
				name = "player03.png",
				spriteColorRect = { x = 0, y = 0, width = 83, height = 75 },
				textureRect = { x = 2, y = 351, width = 83, height = 75 },
				spriteSourceSize = { width = 83, height = 75 },
				spriteTrimmed = false,
				textureRotated = false
			},
			{
				name = "player04.png",
				spriteColorRect = { x = 0, y = 0, width = 83, height = 75 },
				textureRect = { x = 2, y = 274, width = 83, height = 75 },
				spriteSourceSize = { width = 83, height = 75 },
				spriteTrimmed = false,
				textureRotated = false
			},
			{
				name = "player05.png",
				spriteColorRect = { x = 0, y = 0, width = 83, height = 75 },
				textureRect = { x = 2, y = 197, width = 83, height = 75 },
				spriteSourceSize = { width = 83, height = 75 },
				spriteTrimmed = false,
				textureRotated = false
			},
			{
				...
				textureRect = { x = 172, y = 197, width = 154, height = 32 },
