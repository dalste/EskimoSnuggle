...
function scene:createScene( event )
	...
	tutorialMainText = display.newRetinaText( "Your party of eskimos will be given", 0, 0, "Cubano", 18 )
	tutorialMainText:setTextColor( 65, 132, 187 )
	group:insert( tutorialMainText )

	tutorialSubText = display.newRetinaText( "Movement Challenges", 0, 0, "Cubano", 42 )
...
onTap = function( event )
	...
	transition.to( tutorialSubText, { alpha = 0, time = 500, delay = 200, onComplete = function() storyboard.gotoScene( "scenes.tutorial04" ) end })
end
