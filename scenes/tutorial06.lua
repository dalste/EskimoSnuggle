...
function scene:createScene( event )
	...
	tutorialMainText = display.newRetinaText( "And you can't use limbs that have been frostbitten.", 0, 0, "Cubano", 16 )
	tutorialMainText:setTextColor( 65, 132, 187 )
	group:insert( tutorialMainText )

	tutorialSubText = display.newRetinaText( "So Move Swiftly!", 0, 0, "Cubano", 42 )
...
onTap = function( event )
	...
	transition.to( tutorialSubText, { alpha = 0, time = 500, delay = 200, onComplete = function() storyboard.gotoScene( "scenes.tutorial07" ) end })
end
