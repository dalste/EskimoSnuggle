...
function scene:createScene( event )
	...
	tutorialMainText = display.newRetinaText( "Eskimo Snuggle is a", 0, 0, "Cubano", 24 )
	tutorialMainText:setTextColor( 65, 132, 187 )
	group:insert( tutorialMainText )

	tutorialSubText = display.newRetinaText( "Physical Party Game", 0, 0, "Cubano", 42 )
...
onTap = function( event )
	...
	transition.to( tutorialSubText, { alpha = 0, time = 500, delay = 200, onComplete = function() storyboard.gotoScene( "scenes.tutorial02" ) end })
end
